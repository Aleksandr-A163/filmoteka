...
class FetchApi extends Pagination {
  constructor() {
    super.this.paginationElement = document.getElementById('pagination');
    super.this.arrowLeft = document.querySelector('.arrow_left');
    super.this.arrowRight = document.querySelector('.arrow_right');
    super.this.fetchQuery = '';
  }
